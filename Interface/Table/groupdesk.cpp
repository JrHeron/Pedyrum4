...
void GroupDesk::input()
{
    ...
    lMediaStatics->setText(tr("MÈdia"));
    ...
    f.setPointSize(12);
    lGroupMediaTitle->setText(tr("MÈdia"));
    ...
    SBGroupMedia->setPrefix(tr("N˙mero de pessoas pagantes: "));
...
void GroupDesk::onClick_Items(int index)
{
    ...
    if (itemDesk[selected()]->data->isChildren()){
        qDebug() << "Desativar PaymentView aqui, pq ele È filho.";
...
void GroupDesk::back()
{
    qDebug() << "[GroupDesk] [back] local de atualiza√ß√£o do dataOrder";
